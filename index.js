...
const totalAmount = totalAmountraised.toLocaleString('en-US');
...
function showAllGames() {
    ...
    let listOfAllGames = GAMES_JSON.filter ( (game) => {
        return true;
      });
...
// use filter or reduce to count the number of unfunded games
    ...
    let countOfUnfundedGames = listOfUnfundedGames.length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${totalAmountraised.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently, ${countOfUnfundedGames} ${(countOfUnfundedGames === 1) ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
...
let [firstGame, secondGame, ...otherGame] = sortedGames;
